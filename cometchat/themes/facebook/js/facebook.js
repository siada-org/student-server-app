        ...
        return {
            ...
            loggedOut: function(){
                ...
                if(settings.ccauth.enabled=="1"){
                    ...
                    $("#loggedout").attr("data-title",language[77]);
                }else{
                    $("#loggedout").addClass("cometchat_optionsimages_exclamation");
                    $("#loggedout").attr("data-title",language[8]);
                }
                $("#loggedout").show();
