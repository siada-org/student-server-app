...
$bannedWords = array( 'Амфетамин','апездал','апездошенная','без пизды','блядки','блядовать','блядство','блядь','в пизде','в пизду','в хуй не дует','взъёбка','впиздячить','всего ни хуя','вхуюжить','вхуярить','вхуячить','выебать','выебон','выёбываться','выпиздеться','выпиздить','гашик','гашиш','гомосек','до ебанной матери','до хуя','до хуя и больше','доебаться','долбоёб','допиздеться','до-пизды','дуроёб','ебало','ебальник','ебанатик','ёбанный','ебанутый','ебануть','ёбаный в рот','ебаришка','ёбарь','ебаторий','ебать','ебать его конем','ебать меня в рот','ебать мой рот','ебать мозги','ебать му-му','ебать его в рот','ебать-колотить','ебаться','ебаться-сраться','ебистика','ебись','ебическая сила','еблан','ебливая','еблище','ебло','еблом щелкать','еблысь','ёбля','ёбнутый','ёбнуть','ёбнуться','ёболызнуть','ебош','ёбс','ебукентий','ебунок','за всю хуйню','заёб','заебал','заёбанный','заебатый','заебать','заебаться','заебись','запиздеть','захуярить','злаебучий','злоебучая','иди на хуй','испиздить','исхуячить','какого хуя','Кокс','колдоебина','коноёбиться','манда','мандовошка','мозгоёб','мокрощелка','мудоёб','на хуй','на хуй послать','на хуй сесть','на хую видеть','на хуя','наебал','наебаловка','наебка','наебнуть','наебнуться','напиздеть','напиздить','настоебать','нахуяриться','нехуй','ни хуя','ни хуя себе','однохуйственно','опизденеть','остопиздеть','остсосут','отебукать','отпиздить','отсос','отсосать','отсосу','отхуевертить','отъебаться','отъебись','охуевший','охуенно','охуенный','охуеть','охуительный','охуячить','перехуярить','пидарас','пизда','пизда малосольная','пизданутый','пиздануть','пиздатый','пиздёж','пизденыш','пиздёныш','пиздеть','пиздец','пиздить','пиздобол','пиздобратия','пиздой накрыться','пиздолет','пиздорванец ','пиздорванка','пиздошить','пиздуй','пиздун','пизды дать','пизды получить','пиздюк','пиздюлей навешать','пиздюли','пиздюлина','пиздюрить','пиздюхать','пиздюшник','подзалупный','поебать','поебень','поебустика','попиздеть','попиздили','по-хую','похуярили','приебаться','припиздак','припиздить','прихуярить','проебать','проебаться','пропиздить','разёбанный','разъебай','разъебанный','разъебать','разъебаться','распиздон','распиздяй','расхуюжить','расхуячить','с хуеву душу','с хуеву тучу','самого хоть в жопу еби','сосёшь хуй','Спайс','спиздить','схуярить','трахать','тянуть за хуй','угондошить','уебан','уебать','уебок','уёбывать','упиздить','хер','хитровыебанный','хоть бы хуй','худоёбина','хуебратия','хуёв насовать','хуеватенький','хуевато','хуевертить','хуёвина','хуёвничать','хуево','хуёво','хуёвый','хуеглот','хуегрыз','хуем груши околачивать','хуё-моё','хуемырло','хуеплёт','хуесос','хуета','уетень','хуеть','хуй','хуй в рот','хуй важный','хуй его знает','хуй забить','хуй знает что','хуй к носу прикинуть','хуй','хуила','хуйло','хуйнуть','хуйню спороть','хуйня','хуистика','хуй-чего','хули','хуя','хуяк','хуями обложить','хуячить','через хуй кинуть','членоплет','членосос','шлюха','шобла-ёбла' );
$bannedUserIPs = array(  );
$bannedUserIDs = array();
$bannedMessage = 'Вы забанены и ваше сообщение не доставлено';
