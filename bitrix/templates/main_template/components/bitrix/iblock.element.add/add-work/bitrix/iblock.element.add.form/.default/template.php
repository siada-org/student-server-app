...
<form name="iblock_add" action="<?=POST_FORM_ACTION_URI?>" method="post" enctype="multipart/form-data">
	...
	<table class="data-table" style="width: 100%">
		<thead>
			<tr>
				<td colspan="2" style="text-align: center; font-size: large;">Редактирование задания</td>
			</tr>
		</thead>
			...
			<?foreach ($arResult["PROPERTY_LIST"] as $propertyID):?>
				<tr class="work-stroke">
					<td>
						...
						<div class="fileform"><div class="selectbutton">Загрузить файл</div><input id="upload" type="file" size="<?=$arResult["PROPERTY_LIST_FULL"][$propertyID]["COL_COUNT"]?>"  name="PROPERTY_FILE_<?=$propertyID?>_<?=$arResult["ELEMENT_PROPERTIES"][$propertyID][$i]["VALUE_ID"] ? $arResult["ELEMENT_PROPERTIES"][$propertyID][$i]["VALUE_ID"] : $i?>" /></div><br />
									<?
		...
		<tfoot>
			<tr>
				<td colspan="2">
					<input class="btn btn-block color-main btn-sm" style="width: 75%; height: 50px; margin: 0 auto" type="submit" name="iblock_submit" value="<?=GetMessage("IBLOCK_FORM_SUBMIT")?>" />
				</td>
			</tr>
		</tfoot>
	</table>
