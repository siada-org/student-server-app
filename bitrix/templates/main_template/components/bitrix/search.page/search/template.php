	...
	<form action="" method="get">
		...
		<? if ($arParams["SHOW_WHERE"]): ?>
			&nbsp;<select name="where">
				...
				<?
				$arResult["DROPDOWN"]["forum"] = "Комментарии";
				$arResult["DROPDOWN"]["blog"] = "Пользователи";
				?>
			...
			<? foreach ($arResult["SEARCH"] as $arItem): ?>
				<tr valign="top">
					<td>
						...
						<? else: ?>
							<?
							$a=CUser::GetById($arItem['PARAM2']);
							$b=$a->Fetch();
							?>
							<img src="<?
							echo CFile::GetPath($b["PERSONAL_PHOTO"]);
							 ?>" width="56">
							<a href="/p/users/index.php?id=<? echo $arItem['PARAM2'] ?>"><? echo $arItem["TITLE_FORMATED"] ?></a>
