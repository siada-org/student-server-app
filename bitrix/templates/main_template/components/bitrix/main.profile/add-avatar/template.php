...
<div class="bx-auth-profile">
	...
	<form method="post" name="form1" action="<?= $arResult["FORM_TARGET"] ?>" enctype="multipart/form-data">
		...
		<div style="display: none" class="profile-link profile-user-div-link"><a
				title="<?= GetMessage("REG_SHOW_HIDE") ?>" href="javascript:void(0)"
				onclick="SectionClick('reg')"><?= GetMessage("REG_SHOW_HIDE") ?></a></div>
		<div class="profile-block-<?= strpos($arResult["opened"], "reg") === false ? "hidden" : "shown" ?>"
			 id="user_div_reg" style="display: none">
		...
		<div style="display: none" class="profile-link profile-user-div-link"><a
				...
				onclick="SectionClick('personal')"><?= GetMessage("USER_PERSONAL_INFO") ?></a></div>
		<table class="data-table profile-table">
			...
			<div style="width: 100%; font-size: large; font-weight: bold;text-align: center"><?= GetMessage("USER_PHOTO") ?></div>

			<div class="fileform">
				<div class="selectbutton">Сделать фото</div>
				<input id="upload" class="typefile" type="file" accept="image/*" name="PERSONAL_PHOTO"></div>
			<?
			if (strlen($arResult["arUser"]["PERSONAL_PHOTO"]) > 0) {
				...
				?>
				<div  style="margin:5px; border-bottom-right-radius: 3px; position: relative; width: 95%; height: 500px; background: url(<? echo $avatarPath ?>) no-repeat center; background-size: cover">
		...
		<div style="display: none" class="profile-link profile-user-div-link"><a
				title="<?= GetMessage("USER_SHOW_HIDE") ?>" href="javascript:void(0)"
				onclick="SectionClick('work')"><?= GetMessage("USER_WORK_INFO") ?></a></div>
		<div style="display: none" id="user_div_work"
		...
		if ($arResult["INCLUDE_FORUM"] == "Y") {
			...
			<div style="display: none" class="profile-link profile-user-div-link"><a
					title="<?= GetMessage("USER_SHOW_HIDE") ?>" href="javascript:void(0)"
					onclick="SectionClick('forum')"><?= GetMessage("forum_INFO") ?></a></div>
			<div style="display: none" id="user_div_forum"
		...
		if ($arResult["INCLUDE_BLOG"] == "Y") {
			...
			<div style="display: none" class="profile-link profile-user-div-link"><a
					title="<?= GetMessage("USER_SHOW_HIDE") ?>" href="javascript:void(0)"
					onclick="SectionClick('blog')"><?= GetMessage("blog_INFO") ?></a></div>
			<div style="display: none" id="user_div_blog"
		...
		<? if ($arResult["INCLUDE_LEARNING"] == "Y"): ?>
			<div style="display: none" class="profile-link profile-user-div-link"><a
					title="<?= GetMessage("USER_SHOW_HIDE") ?>" href="javascript:void(0)"
					onclick="SectionClick('learning')"><?= GetMessage("learning_INFO") ?></a></div>
			<div style="display: none" id="user_div_learning"
		...
		<? if ($arResult["USER_PROPERTIES"]["SHOW"] == "Y"): ?>
			...
			<div style="display: none" id="user_div_user_properties"
