			...
			for (var i = 0; i < data.length; i++)
			{
				...
				if (command == 'm')
				{
					...
					if (data[i + 2].substr(0, 2) == "IN")
					{
						...
						{
							sonetChatMsgs += '<br /><div class="message-incoming">'
								+ '<span class="message-text">' + data[i + 3] + '</span></div><span class="socnet-chat-date">' + sonet_chat_date(data[i + 1]) + '</span><br/><br/><br/>';
							bShowMess = true;
							bShowNotice = true;
							bSoundMessage = true;
						}
					...
					{
						sonetChatMsgs += '<br />'
							+ '<div class="date-out"><span class="socnet-chat-date-outcoming">' + sonet_chat_date(data[i + 1]) + '</span></div><div class="message-outcoming"><span class="message-text">' + data[i + 3] + '</span></div><br/><br/><br/>';
						bShowMess = true;
					}
