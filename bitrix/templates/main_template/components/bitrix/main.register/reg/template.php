...
?>
<div class="row" style="margin-top: 30vh; padding: 0 30px">
<div class="bx-auth-reg">
	...
	<? else: ?>
		...
		<form method="post" action="<?= POST_FORM_ACTION_URI ?>" name="regform" enctype="multipart/form-data">
			...
			<? foreach ($arResult["SHOW_FIELDS"] as $FIELD): ?>
				...
				<span class="bx-auth-secure" title="<? echo GetMessage("AUTH_NONSECURE_NOTE") ?>">
					<div class="bx-auth-secure-icon bx-auth-secure-unlock"></div>
							...
							<div class="input-group">
								<span class="input-group-addon"><i class="fa fa-fw fa-lock"></i> </span>
								<input class="form-control" type="password" name="REGISTER[<?= $FIELD ?>]"
									   value="<?= $arResult["VALUES"][$FIELD] ?>" autocomplete="off"/>
							</div><?
								break;
							...
							<div class="input-group">
								...
								<input id="phone" class="form-control" size="12" type="tel" name="REGISTER[<?= $FIELD ?>]"
			...
			<input class="btn btn-block btn-primary btn-lg" style="margin-top: 15px;" type="submit"
