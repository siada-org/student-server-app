(function (b) {
    b.fn.accordion = function (i) {
        ...
        i && b.extend(a, i);
        this.each(function () {
            var e = b(this), f = {height: 0, marginTop: 0, marginBottom: 0, paddingTop: 0, paddingBottom: 0};
            e.find(">li>" + a.panel).each(function () {
                ...
                c.removeClass(a.loadingClass).css("visibility", "hidden").data("dimensions", {
                    ...
                    h.css(b.extend({overflow: "hidden"}, f)).addClass(a.activeClassPanel).show().animate(b.browser.msie && parseInt(b.browser.version) < 8 ? h.data("dimensions") : b.extend({opacity: 1}, h.data("dimensions")), {
                    ...
                    d.removeClass(a.activeClassPanel).css({overflow: "hidden"}).animate(b.browser.msie && parseInt(b.browser.version) < 8 ? f : b.extend({opacity: 0}, f), {
                        duration: a.speed,
                        easing: a.easing,
                        queue: false,
                        complete: function () {
            ...
            e.delegate(".accordion-opener", "click", function (c) {
                ...
                c = b(this).closest("li");
                var d = c.find(">" + a.panel).first(), g = e.find(" > li:not(." + a.lockedClass + ") > " + a.panel + "." + a.activeClassPanel);
                if (!c.hasClass(a.lockedClass))if (d.is(":visible"))a.canToggle && d.trigger("panel-close"); else {
